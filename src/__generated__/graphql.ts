...
export type Query = {
  ...
  myBarPopoverDismissed?: Maybe<Scalars['Boolean']['output']>;
  /** Retrieve a record by its `ID` */
  node?: Maybe<Node>;
  partialMatchInfoBoxDismissed?: Maybe<Scalars['Boolean']['output']>;
...
export type GetLocalStateQuery = { __typename?: 'Query', selectedUnitSystem?: string | null, selectedJiggerSize?: number | null, doubleRecipe?: boolean | null, partialMatchInfoBoxDismissed?: boolean | null, totalMatchInfoBoxDismissed?: boolean | null, myBarPopoverDismissed?: boolean | null };
...
export const GetLocalStateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getLocalState"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"selectedUnitSystem"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"client"}}]},{"kind":"Field","name":{"kind":"Name","value":"selectedJiggerSize"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"client"}}]},{"kind":"Field","name":{"kind":"Name","value":"doubleRecipe"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"client"}}]},{"kind":"Field","name":{"kind":"Name","value":"partialMatchInfoBoxDismissed"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"client"}}]},{"kind":"Field","name":{"kind":"Name","value":"totalMatchInfoBoxDismissed"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"client"}}]},{"kind":"Field","name":{"kind":"Name","value":"myBarPopoverDismissed"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"client"}}]}]}}]} as unknown as DocumentNode<GetLocalStateQuery, GetLocalStateQueryVariables>;
